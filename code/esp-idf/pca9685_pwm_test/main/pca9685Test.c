...
void task_PCA9685(void *ignore)
{
    ...
    int16_t servo_min[12] = {153,138-10,138+0,  123-7+5,123-12+15,123-9+10,     123+8,123-50-0,123+10-8,    140-10,143+15,123+12+5}; //3% 
    int16_t servo_max[12] = {515,490-10,498+0,   450+35+5,450+30+15,450+35+10,   450+48,450+15-0,450-20-8,   505-10,490+15,450-10+5}; //12%
